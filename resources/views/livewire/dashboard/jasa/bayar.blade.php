<div>
    ...
    <div class="flex flex-col items-center justify-center min-h-[60vh]">
        <div class="text-center mb-6">
            <h1 class="text-2xl font-semibold mb-2">Pembayaran Jasa</h1>
        ...
        <div class="w-full max-w-md p-6 bg-white rounded-2xl shadow-xl shadow-neutral-200">
            <div class="mb-6 pb-6 border-b">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="font-medium">{{ $jasa->invoice_number }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-neutral-500">Total Pembayaran</span>
                    <span class="font-medium">Rp {{ number_format($jasa->total_amount, 0, ',', '.') }}</span>
                </div>
            </div>

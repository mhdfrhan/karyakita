...
<nav x-data="{ open: false }"
    class="bg-indigo-400 border border-indigo-400 z-40 relative rounded-2xl xl:hidden mb-8 print:hidden">
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="shrink-0 flex items-center">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('assets/img/logo-white.png') }}" class="h-10" alt="{{ config('app.name', 'Laravel') }} Logo">
                </a>
            </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-lg border bg-indigo-500 border-indigo-500 text-light focus:outline-none focus:bg-indigo-400 transition duration-150 ease-in-out">
                    <svg class="size-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
